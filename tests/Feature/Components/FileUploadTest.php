...
it('renders the file upload component with default label', function () {
...
it('renders with custom label and hint', function () {
...
it('renders preview image when provided', function () {
    $view = $this->blade('<x-file-upload preview="/img/test.jpg" />');

    $view->assertSee('src="/img/test.jpg"', false);
});

it('renders remove button when removable with preview', function () {
