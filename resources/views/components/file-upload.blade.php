    ...
    @if ($preview)
        <div class="relative inline-block">
            <img
                src="{{ $preview }}"
                alt="Preview"
                class="h-32 w-32 rounded-radius border border-outline object-cover dark:border-outline-dark"
            />
        ...
        >
            <div class="flex flex-col items-center gap-2 text-center">
                <div class="rounded-full bg-surface-alt p-2 dark:bg-surface-dark-alt">
                    <svg
                        class="size-6 text-on-surface/60 dark:text-on-surface-dark/60"
