    ...
    x-data="{
        ...
        addNotification({ content = '', type = 'info' }) {
            ...
            const notification = {
                ...
                paused: false,
                startTime: Date.now(),
                remaining: this.displayDuration,
            }
        ...
        pauseNotification(notification) {
            ...
            notification.remaining =
                notification.remaining - (Date.now() - notification.startTime)
        },
...
>
    <template x-for="notification in notifications" :key="notification.id">
        ...
        >
            ...
            {{-- Content --}}
            <p
                class="text-sm text-on-surface-strong dark:text-on-surface-dark-strong"
            ...
            <button
                ...
                class="ml-auto shrink-0 text-on-surface hover:text-on-surface-strong dark:text-on-surface-dark dark:hover:text-on-surface-dark-strong"
