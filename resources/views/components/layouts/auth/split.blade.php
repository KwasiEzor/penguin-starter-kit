...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body
        class="min-h-screen antialiased bg-surface dark:bg-linear-to-b dark:from-surface-dark dark:to-surface-dark-alt"
    >
        <!-- Main Container -->
        <div
            ...
            <div class="w-full lg:p-8">
                <div class="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-87.5">
                    ...
                    <a href="{{ route('home') }}" class="flex flex-col items-center gap-2 font-medium lg:hidden">
                        ...
                        />
                        <span class="sr-only">{{ config('app.name', 'Penguin Starter Kit') }}</span>
                    </a>
