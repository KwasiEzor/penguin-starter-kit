<div class="flex flex-col gap-6">
    ...
    <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        @if ($paymentsEnabled)
            <x-stat-card :label="__('Active Subscriptions')" :value="$activeSubscriptions" color="primary" :href="route('admin.payments')">
                <x-slot:icon>
                    <svg class="size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <x-stat-card :label="__('Monthly Revenue')" :value="'$' . number_format($monthlyRevenue / 100, 2)" color="success" :href="route('admin.payments')">
                <x-slot:icon>
                    <svg class="size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
