<div>
                ...
                <tr wire:key="product-{{ $product->id }}">
                    ...
                    <x-table-cell>
                        <div class="flex items-center gap-2">
                            <x-button size="xs" variant="ghost" wire:click="editProduct({{ $product->id }})">
                                {{ __('Edit') }}
                            </x-button>
            ...
            >
                ...
                >
                    <x-typography.heading accent>
                        {{ $editingProductId ? __('Edit Product') : __('Create Product') }}
    ...
    <x-modal :show="$deletingProductId !== null" maxWidth="md">
        ...
        >
            ...
            <x-button variant="danger" type="button" wire:click="deleteProduct">
                {{ __('Delete Product') }}
            </x-button>
        </div>
    </x-modal>
