<div class="flex flex-col items-center justify-center gap-6 py-12">
    <div class="rounded-full bg-warning/10 p-4">
        <svg class="size-12 text-warning" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
    ...
    <div class="text-center">
        ...
        <p class="mt-2 text-sm text-on-surface dark:text-on-surface-dark">{{ __('Your payment was cancelled. No charges were made.') }}</p>
    </div>
