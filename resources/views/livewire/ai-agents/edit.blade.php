<div class="flex flex-col gap-6">
    ...
    <div>
        ...
        <x-typography.heading accent size="xl" level="1">{{ __('Edit Agent') }}</x-typography.heading>
        <x-typography.subheading size="lg">{{ __('Update agent configuration') }}</x-typography.subheading>
    </div>
