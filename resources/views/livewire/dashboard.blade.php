            ...
            <x-card>
                <x-slot name="header">
                    <div class="flex items-center justify-between">
                        ...
                        <x-button size="xs" variant="ghost" href="{{ route('posts.create') }}">
                            {{ __('New Post') }}
                        </x-button>
                    </div>
                </x-slot>
                    ...
                    >
                        <div class="flex-1 min-w-0">
                            <a
                                ...
                                class="text-sm font-medium text-on-surface-strong hover:text-primary dark:text-on-surface-dark-strong dark:hover:text-primary-dark truncate block"
                                wire:navigate
                            >
                                {{ $post->title }}
                            </a>
                ...
                @empty
                    <div class="py-6 text-center">
                        ...
                        <x-button size="xs" class="mt-3" href="{{ route('posts.create') }}">
        ...
        <div class="flex flex-col gap-6">
            ...
            <x-card>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-lg font-bold text-on-surface-strong dark:text-on-surface-dark-strong">
                            {{ $postsThisWeek }}
                        </p>
                        <p class="text-xs text-on-surface dark:text-on-surface-dark">
                            {{ trans_choice('post created|posts created', $postsThisWeek) }}
                        </p>
                    </div>
                </div>
            </x-card>
