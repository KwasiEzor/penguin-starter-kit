<div>
        ...
        <div class="mt-6 mb-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="flex flex-col gap-2">
                    <label
                        class="inline-flex cursor-pointer items-center gap-2 rounded-radius border border-outline px-3 py-1.5 text-sm font-medium text-on-surface-strong transition-colors hover:bg-surface-alt dark:border-outline-dark dark:text-on-surface-dark-strong dark:hover:bg-surface-dark-alt"
                    >
                        <svg
                            class="size-4"
    ...
    <section class="mt-10 space-y-6">
        ...
        <x-modal name="confirm-user-deletion" :maxWidth="'lg'">
            ...
            <x-slot name="header">
                <x-typography.subheading accent size="lg">
